(function () {
  ...
  el.innerHTML =
    '<p style="margin:0;max-width:520px;">' +
      'Este sitio no usa cookies de rastreo ni publicidad, solo lo necesario para funcionar. ' +
      'Más info en nuestra <a href="/privacidad" style="color:#f7efd9;text-decoration:underline;">Política de Privacidad</a>.' +
    '</p>' +
